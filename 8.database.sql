DROP TABLE IF EXISTS final_zotus;
CREATE TABLE final_zotus (
	OTUId VARCHAR(32) PRIMARY KEY NOT NULL,
	YX1D56R21 INTEGER, 
	YX4D56R21 INTEGER, 
	ConD0R21 INTEGER, 
	ConD56R21 INTEGER, 
...
LOAD DATA LOCAL INFILE "data/combined.zotus.xls" INTO TABLE final_zotus FIELDS TERMINATED BY '\t' IGNORE 1 LINES;

DROP TABLE IF EXISTS final_zotus_classifications;
CREATE TABLE final_zotus_classifications (
...
LOAD DATA LOCAL INFILE "data/combined.zotus.classified.flat.xls" INTO TABLE final_zotus_classifications FIELDS TERMINATED BY '\t';
