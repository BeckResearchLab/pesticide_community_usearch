...
SELECT ot.OTUId,
	...
	WHERE 0
		OR (ConD0R12 / (SELECT SUM(ConD0R12) FROM final_zotus) > 0.010000)
		OR (ConD0R21 / (SELECT SUM(ConD0R21) FROM final_zotus) > 0.010000)
		OR (ConD56R21 / (SELECT SUM(ConD56R21) FROM final_zotus) > 0.010000)
		OR (ConD7R21 / (SELECT SUM(ConD7R21) FROM final_zotus) > 0.010000)
		OR (CX1D56R21 / (SELECT SUM(CX1D56R21) FROM final_zotus) > 0.010000)
		OR (CX1D7R21 / (SELECT SUM(CX1D7R21) FROM final_zotus) > 0.010000)
		OR (CX4D56R21 / (SELECT SUM(CX4D56R21) FROM final_zotus) > 0.010000)
		OR (CX4D7R21 / (SELECT SUM(CX4D7R21) FROM final_zotus) > 0.010000)
		OR (YX1D56R21 / (SELECT SUM(YX1D56R21) FROM final_zotus) > 0.010000)
		OR (YX1D7R21 / (SELECT SUM(YX1D7R21) FROM final_zotus) > 0.010000)
		OR (YX4D56R21 / (SELECT SUM(YX4D56R21) FROM final_zotus) > 0.010000)
		OR (YX4D7R21 / (SELECT SUM(YX4D7R21) FROM final_zotus) > 0.010000)
		OR (ConD56R12 / (SELECT SUM(ConD56R12) FROM final_zotus) > 0.010000)
		OR (ConD7R11 / (SELECT SUM(ConD7R11) FROM final_zotus) > 0.010000)
		OR (CX1D56R11 / (SELECT SUM(CX1D56R11) FROM final_zotus) > 0.010000)
		OR (CX1D7R11 / (SELECT SUM(CX1D7R11) FROM final_zotus) > 0.010000)
		OR (CX4D56R11 / (SELECT SUM(CX4D56R11) FROM final_zotus) > 0.010000)
		OR (CX4D7R11 / (SELECT SUM(CX4D7R11) FROM final_zotus) > 0.010000)
		OR (DConD0R1 / (SELECT SUM(DConD0R1) FROM final_zotus) > 0.010000)
		OR (DConD0R2 / (SELECT SUM(DConD0R2) FROM final_zotus) > 0.010000)
		OR (YX1D56R11 / (SELECT SUM(YX1D56R11) FROM final_zotus) > 0.010000)
		OR (YX1D7R11 / (SELECT SUM(YX1D7R11) FROM final_zotus) > 0.010000)
		OR (YX4D56R11 / (SELECT SUM(YX4D56R11) FROM final_zotus) > 0.010000)
		OR (YX4D7R11 / (SELECT SUM(YX4D7R11) FROM final_zotus) > 0.010000)
	GROUP BY ot.OTUId
	ORDER BY ( 0
			+ ConD0R12
			+ ConD0R21
